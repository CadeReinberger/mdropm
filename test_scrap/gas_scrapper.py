from gas_fem import solve_concentration_field, compute_concentration_gradients
import heightscape
import tapescape
...
# Get the concentration gradients
grads = compute_concentration_gradients(dr_x, dr_y, pu)
print(f'grads: {grads}')
